function out = similarity_batch_parallel_assign_pub(folder1,Filedir2,mindur,winsize)
format compact
format short g
...
[Sound1,Sound2,same]=createSimStructure_assign(mindur,winsize,sounds1d,sounds2d);
...
percent = parfor_progress(length(Sound2));
same=0;
