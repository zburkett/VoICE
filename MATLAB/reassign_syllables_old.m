function varargout = reassign_syllables_old(varargin)
% REASSIGN_SYLLABLES_OLD MATLAB code for reassign_syllables_old.fig
%      REASSIGN_SYLLABLES_OLD, by itself, creates a new REASSIGN_SYLLABLES_OLD or raises the existing
%      singleton*.
%
%      H = REASSIGN_SYLLABLES_OLD returns the handle to a new REASSIGN_SYLLABLES_OLD or the handle to
%      the existing singleton*.
%
%      REASSIGN_SYLLABLES_OLD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in REASSIGN_SYLLABLES_OLD.M with the given input arguments.
%
%      REASSIGN_SYLLABLES_OLD('Property','Value',...) creates a new REASSIGN_SYLLABLES_OLD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before reassign_syllables_old_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to reassign_syllables_old_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help reassign_syllables_old

% Last Modified by GUIDE v2.5 22-Sep-2014 10:17:01

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @reassign_syllables_old_OpeningFcn, ...
                   'gui_OutputFcn',  @reassign_syllables_old_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before reassign_syllables_old is made visible.
function reassign_syllables_old_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to reassign_syllables_old (see VARARGIN)
...
% Choose default command line output for reassign_syllables_old
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes reassign_syllables_old wait for user response (see UIRESUME)
...
function varargout = reassign_syllables_old_OutputFcn(hObject, eventdata, handles) 
