...
tmp_struct=cell2struct(answer(1),'tmp',1); %save
param.window=round(str2num(tmp_struct.tmp)*fs);
tmp_struct=cell2struct(answer(2),'tmp',1); %save
param.winstep=round(str2num(tmp_struct.tmp)*fs);
