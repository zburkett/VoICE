...
if(.Platform$OS.type=="unix")
{
	...
	}else if (file.exists(paste(folder1,"voice_results/assign_workspace.Rdata",sep="/"))) #changed to an else if by ZB 9/17/14 to fix reassignment issue
	{
	...
	if(file.exists(paste(folder1,"voice_results/sorted_syllables_for_batch/",sep="")))
	{
		 unlink(paste(folder1,"voice_results/sorted_syllables_for_batch/",sep=""),recursive=TRUE)		
	}
		
	dir.create(paste(folder1,"voice_results/sorted_syllables_for_batch/",sep=""))
	...
	#for(cluster in goodClusters)
		{
			...
			dir.create(paste(folder1,"voice_results/sorted_syllables_for_batch/",cluster,sep=""))
			...
			for(name in final.reps)
			{
				...
				file.copy(paste(folder1,"/voice_results/cut_syllables/",name.out,".wav",sep=""),paste(folder1,"voice_results/sorted_syllables_for_batch/",cluster,"/",name.out,".wav",sep=""))
			}
		}
	#}
}else if (.Platform$OS.type=="windows")
{
	...
	{
	    load(paste(folder1,"voice_results/workspace.Rdata",sep=""))
	}else if (file.exists(paste(folder1,"voice_results/assign_workspace.Rdata",sep="")))
	{
	    load(paste(folder1,"voice_results/assign_workspace.Rdata",sep=""))
	    assignedSyntax <- saveList$out.assign #added by ND 9/16/14 in lieu of loading assigned_workspace_complete
	}
